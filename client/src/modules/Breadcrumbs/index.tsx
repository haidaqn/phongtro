            ...
            <div className="flex gap-7 justify-center items-center mt-3 capitalize text-lg">
                <Link href="/">
                    <div className='h-48 bg-white rounded-lg '>
                        <Image src={hcm} alt="Picture of the author" className='w-[200px] rounded-t-lg h-40 object-cover' />
                        <h1 className='text-center font-medium text-main hover:text-orange-300'>hồ chí minh</h1>
                    </div>
                </Link>
                <Link href="/">
                    <div className='h-48 bg-white rounded-lg '>
                        <Image src={danang} alt="Picture of the author" className='w-[200px] rounded-t-lg h-40 object-cover' />
                        <h1 className='text-center font-medium text-main hover:text-orange-300'>đà nẵng</h1>
                    </div>
                </Link>
                <Link href="/">
                    <div className='h-48 bg-white rounded-lg '>
                        <Image src={hn} alt="Picture of the author" className='w-[200px] rounded-t-lg h-40 object-cover' />
